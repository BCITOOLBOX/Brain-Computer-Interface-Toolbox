function [ccobj, pp]=mcbtr_tr(datafiles,predt,postdt,chid,ftid,targets,ft,ftmrk,testid)
%[rfobject pp]=mcbtr_tr(dataFiles,predt,postdt,chid,ftid,targets,ft,ftmrk,testid)
% Train a Boosted Tree (AdaBoost) classifier for multiclass EEG BCI 
% classification.
...
%
% Example usage:
%  [rfobj pp]=mcbtr_tr({'nkdeney-example.mat'},0,0.85,1:21,'sfrqz5',1:3);
%
