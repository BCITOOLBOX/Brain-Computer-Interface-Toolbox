function [ccobj, pp]=mcknn_tr(datafiles,predt,postdt,chid,ftid,targets,ft,ftmrk,testid)
%[knnobject,pp]=mcknn_tr(dataFiles,predt,postdt,chid,ftid,targets,ft,ftmrk,testid)
% Train a kNN classifier for multiclass EEG BCI classification.
...
%
% Example usage:
%  [knnobj,pp]=mcknn_tr({'nkdeney-example.mat'},0,0.85,1:21,'sfrqz5',1:3);
%
% This function uses knncfit Matlab's function and requires Matlab 8.5 
% or higher.
%
% Y.Mishchenko (c) 2016
