function [ccobj, pp]=mcrbe_tr(datafiles,predt,postdt,chid,ftid,targets,ft,ftmrk,testid)
%[rfobject pp]=mcrbe_tr(dataFiles,predt,postdt,chid,ftid,targets,ft,ftmrk,testid)
% Train a RBe network classifier for multiclass EEG BCI classification.
...
%
% Example usage:
%  [rfobj pp]=mcrbe_tr({'nkdeney-example.mat'},0,0.85,1:21,'sfrqz5',1:3);
%
